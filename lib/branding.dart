...
/// The full logo - Waliya, rainbow, cartelas, bingo balls and BINGO lettering.
/// Generated by tool/generate_logo.py; use it where it renders large enough to
/// read the lettering.
const String kLogoAsset = 'assets/images/logo.png';

/// The same artwork without the lettering, for small placements like the app
/// bar where the wordmark would only turn to mush.
